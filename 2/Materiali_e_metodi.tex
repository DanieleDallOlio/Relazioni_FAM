...
Il MOUSE è stato realizzato per generare un campo magnetico con gradiente costante lungo l'asse $y$ per la componenente $B_z$, dove gli assi sono riferiti in figura \ref{}. 
